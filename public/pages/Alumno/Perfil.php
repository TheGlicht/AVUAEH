  ...
  <!-- php de invocacion de menú -->
    <?php include '../../../resources/templates/menuAlumno.php';?>
      ...
      <div class="card shadow mb-5">
        <div class="card-body">
          <h5 class="card-title text-primary">Avance de Materias</h5>
          <ul class="list-group" id="avanceMaterias">
            <li class="list-group-item">
              Matemáticas <div class="progress"><div class="progress-bar" style="width: 80%">80%</div></div>
            </li>
            <li class="list-group-item">
              Física <div class="progress"><div class="progress-bar bg-success" style="width: 100%">100%</div></div>
            </li>
            <li class="list-group-item">
              Química <div class="progress"><div class="progress-bar bg-warning" style="width: 60%">60%</div></div>
            </li>
          </ul>
        </div>
      </div>
